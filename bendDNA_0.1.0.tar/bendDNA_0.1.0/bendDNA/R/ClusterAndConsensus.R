...
#' AT/TA).
#'
#' @param out A single data.table output of function MatchBendability
...
ClusterAndConsensus <- function(out, cutoff, sample.seq=NULL){
  ...
  sq <- Biostrings::DNAStringSet(out$sequence)
